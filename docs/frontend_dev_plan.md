...
F2  HUD 数据展示        ████████████  80% ✅ 已接入真实引擎状态，跟随回合刷新
F3  决策托盘交互        ████████████  80% ✅ 确认按钮接入 submit_action，回合闭环完成
F4  地图与侧栏占位      ████████░░░░  65% 🔶 叙事信号已接，忠诚度固定3人/派系无趋势箭头
...
3. 右侧边栏叙事已接信号，但忠诚度仍显示固定 3 名将领，派系支持无趋势方向。
4. 地图区仍是静态战略感占位，尚未读取 `map_nodes.json` 做数据驱动布局。
