...
| `BUG-2026-03-27-EVENTBUS-WARNINGS` | `EventBus` 声明型 signal 在 `GdUnit4` 中持续产生 warning 噪音 | P2 | 已修复 | 本轮 `GdUnit4` 日志审计 | Windows headless / smoke / `GdUnit4` | [docs/bugs/bug_eventbus_signal_warnings.md](/mnt/e/projects/CentJours/docs/bugs/bug_eventbus_signal_warnings.md) |
