...
> **说明**: 本文件是常规规则文档，不等于默认启用自动工作流；如用户明确要求连续自动循环，再额外读取 [docs/rules/optional/agent_autonomous_workflow.md](/mnt/e/projects/CentJours/docs/rules/optional/agent_autonomous_workflow.md)。
