...
- Codex harness 现已提供 `codex_pick_next_task.py`、`codex_round_summary.py`、`codex_cycle.sh`、`codex_validation_scope.py` 和 `codex_light_guard.sh`，用于给出下一任务、压缩摘要和本地最小验证建议
