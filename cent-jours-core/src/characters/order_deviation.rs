...
pub fn calculate_deviation<R: Rng>(
    ...
    // 通信距离惩罚
    let distance_penalty = (communication_distance as f64 * DISTANCE_PENALTY_PER_NODE)
...
mod tests {
    ...
    fn davout() -> GeneralData {
        GeneralData {
            id: "davout".into(), name: "Louis Davout".into(),
            loyalty: 95.0, temperament: Temperament::Cautious, military_skill: 92.0,
        }
    }
    ...
    fn 内伊冲动性格倾向提前行动() {
        ...
        // 冲动性格大多数情况下应倾向提前
        assert!(early_action > 60, "内伊倾向提前的比例应>60%，实际={}/100", early_action);
    }
    ...
    fn 格鲁希谨慎性格倾向延迟() {
        ...
        assert!(delayed > 70, "格鲁希倾向延迟的比例应>70%，实际={}/100", delayed);
    }
    ...
    fn 低忠诚度有概率拒绝命令() {
        let traitor = GeneralData {
            id: "traitor".into(), name: "叛将".into(),
            loyalty: 5.0, temperament: Temperament::Balanced, military_skill: 50.0,
        };
    ...
    fn 高忠诚度将领几乎不拒绝() {
        let loyal = GeneralData {
            id: "loyal".into(), name: "忠臣".into(),
            loyalty: 95.0, temperament: Temperament::Balanced, military_skill: 80.0,
        };
