...
> **Author**: Julien
> **Version**: v0.15 — 2026-03-22
> **Status**: Draft — M0/M0.5/M1/M2/M3 完成，GATE 2 通过；M4 测试127个；Godot 前端 Bug 修复与视觉质量提升完成（ADR-004）：叙事滚动日志、Rest 卡、hover scale 动效、全将领忠诚度、Line2D 地图路线、RN 氛围叠加、RN Slider 信号化
