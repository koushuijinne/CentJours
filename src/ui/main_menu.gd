...
const MainMenuContentBuilder = preload("res://src/ui/main_menu/content_builder.gd")
...
func _get_tutorial_stage_for_day(day: int) -> Dictionary:
	return MainMenuContentBuilder.get_tutorial_stage_for_day(day, _tutorial_stages)

func _build_tutorial_hint_text() -> String:
	return MainMenuContentBuilder.build_tutorial_hint_text(_tutorial_stages)

func _build_strategy_context() -> Dictionary:
	return MainMenuContentBuilder.build_strategy_context()


func _build_primary_route_snapshot() -> Dictionary:
	return MainMenuContentBuilder.build_primary_route_snapshot()

func _build_primary_risk_snapshot() -> Dictionary:
	return MainMenuContentBuilder.build_primary_risk_snapshot()

func _build_faction_pressure_snapshot() -> Dictionary:
	return MainMenuContentBuilder.build_faction_pressure_snapshot()
